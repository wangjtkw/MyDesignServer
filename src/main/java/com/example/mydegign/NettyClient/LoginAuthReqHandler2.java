...
//
//public class LoginAuthReqHandler2 extends ChannelInboundHandlerAdapter {
//
//    @Override
...
//        System.out.println("channelActive run log2");
//        MessageProto.Message message = MessageFactory.getMessage(Constant.LOGIN, 2, "logging");
